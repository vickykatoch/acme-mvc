...
namespace Acme.Web
{
    public static class SeedData
    {
        ...
        private static void AddTerminatedCustomers(AcmeContext context)
        {
        ...
        private static void AddExistingCustomers(AcmeContext context)
        {
            context.Customers.Add(new Customer
            {
                Name = "Gosse Greene",
        ...
        private static void AddNewCustomers(AcmeContext context)
        {
            context.Customers.Add(new Customer
            {
                Name = "John Doe",
